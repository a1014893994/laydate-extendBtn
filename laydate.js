  ...
  */
    ...
    ,active = {
      ...
      ,now: function(){
        ...
        ,threeMonth: function(){
            ...
            that.startDate = lay.extend(dateTime, that.systemDate(), {
                year: year
                ,month: month
            ...
            that.endDate = lay.extend({}, that.systemDate(), {
                hours: 23
                ,minutes: 59
                ,seconds: 59
            });
  ...
  Class.prototype.changeEvent = function(){
    ...
    lay(that.footer).find('span').on('click', function(){
      ...
      //扩展-点击顶部按钮
      lay(that.top).find('span').on('click', function(){
          var type = lay(this).attr('lay-type');
          that.tool(this, type);
      });
  };
